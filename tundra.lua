...
Build {
	...
	Units = function ()
		...
		local xlibrary = StaticLibrary {
			Name = "xenv",
			Config = "*-*-*-*",
			Sources = { SourceGlob("source/main/cpp") },
			Includes = { "../xbase/source/main/include","../xenv/source/main/include","../xunittest/source/main/include" },
		}
		...
		local unittest = Program {
			...
			Depends = { xbase_library,xlibrary,xunittest_library },
		}
		Default(unittest)
	end,
	Configs = {
